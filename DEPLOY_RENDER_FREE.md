# Deploy V0.3.1 lên Render Free

## Vì sao V0.3.0 không tạo được Render Free?
`render.yaml` của V0.3.0 có khai báo persistent disk `/var/data`. Render chỉ cho gắn persistent disk vào web service trả phí, nên Blueprint đó không phù hợp với Free.
...
## Lưu ý về dữ liệu
Bản Free dùng filesystem tạm thời. Dữ liệu SQLite và file sinh viên upload có thể mất khi service restart, redeploy hoặc spin down. V0.3.1 Free chỉ nên dùng để thử nghiệm online. Phiên bản dùng chính thức cần database/storage bền vững.
